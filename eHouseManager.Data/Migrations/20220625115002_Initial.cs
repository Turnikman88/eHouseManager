        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 6, 25, 11, 50, 1, 850, DateTimeKind.Utc).AddTicks(5980)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ModifiedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 6, 25, 11, 50, 1, 856, DateTimeKind.Utc).AddTicks(4380)),
                    ModifiedBy = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ModifiedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 6, 25, 11, 50, 1, 861, DateTimeKind.Utc).AddTicks(6241)),
                    ModifiedBy = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ModifiedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 6, 25, 11, 50, 1, 862, DateTimeKind.Utc).AddTicks(3654)),
                    ModifiedBy = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ModifiedOn = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2022, 6, 25, 11, 50, 1, 857, DateTimeKind.Utc).AddTicks(7943)),
                    ModifiedBy = table.Column<string>(nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Apartments",
                columns: new[] { "Id", "Address", "ApartmentNumber", "AreTaxesPaid", "Area", "InhabitantsCount", "ModifiedBy", "ObligationId", "Owner" },
                values: new object[] { 1, null, null, false, 0m, 0, null, null, null });
