...
namespace eHouseManager.Data.Migrations
{
    ...
    [Migration("20220626104126_initial")]
            ...
            modelBuilder.Entity("eHouseManager.Data.DatabaseModels.Apartment", b =>
                {
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 26, 10, 41, 24, 382, DateTimeKind.Utc).AddTicks(8379));
            ...
            modelBuilder.Entity("eHouseManager.Data.DatabaseModels.ApartmentObligationAccess", b =>
                {
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 10, 41, 24, 423, DateTimeKind.Utc).AddTicks(1128));
            ...
            modelBuilder.Entity("eHouseManager.Data.DatabaseModels.Obligation", b =>
                {
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 10, 41, 24, 428, DateTimeKind.Utc).AddTicks(7628));
            ...
            modelBuilder.Entity("eHouseManager.Data.DatabaseModels.TaxPayment", b =>
                {
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 10, 41, 24, 436, DateTimeKind.Utc).AddTicks(9389));
            ...
            modelBuilder.Entity("eHouseManager.Data.DatabaseModels.TaxType", b =>
                {
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 10, 41, 24, 471, DateTimeKind.Utc).AddTicks(8346));
            ...
            modelBuilder.Entity("eHouseManager.Data.DatabaseModels.User", b =>
                {
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 10, 41, 24, 488, DateTimeKind.Utc).AddTicks(872));
            ...
            modelBuilder.Entity("eHouseManager.Data.DatabaseModels.UserApartmentAccess", b =>
                {
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 10, 41, 24, 479, DateTimeKind.Utc).AddTicks(1015));
            ...
            modelBuilder.Entity("eHouseManager.Data.DatabaseModels.UserEventAccess", b =>
                {
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 10, 41, 24, 491, DateTimeKind.Utc).AddTicks(2574));
